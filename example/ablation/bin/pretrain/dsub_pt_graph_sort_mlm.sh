#!/bin/bash
#DSUB -n regformer_pt_graph_sort_mlm
#DSUB -N 1
#DSUB -A root.project.P24Z28400N0259_tmp2
#DSUB -R "cpu=24;gpu=3;mem=80000"
#DSUB -oo ../logs/pt/regformer_pt_graph_sort_mlm.out
#DSUB -eo ../logs/pt/regformer_pt_graph_sort_mlm.err
...
# touch ${NODEFILE}
touch $NODEFILE
config_file=/home/share/huadjyin/home/s_qiuping1/workspace/RegFormer/example/ablation/conf/pretrain/pt_graph_sort_mlm.toml
