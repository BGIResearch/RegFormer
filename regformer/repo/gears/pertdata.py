...
class PertData:
    ...
    def load(self, data_name=None, data_path=None, gene_subset=None):
        ...
        if data_name in ['norman', 'adamson']:
            self.dataset_name = data_name
            self.dataset_path = data_path if data_path is not None else self.data_path
    ...
    def new_data_process(self, dataset_name,
        ...
        save_data_folder = os.path.join(self.data_path)
        ...
        sc.write(os.path.join(save_data_folder, 'perturb_processed.h5ad'), self.adata)
